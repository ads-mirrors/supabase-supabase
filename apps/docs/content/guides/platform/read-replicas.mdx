...
1. Using [physical backups](/docs/guides/platform/backups#point-in-time-recovery)
   ...
   - If you're not using PITR, you'll be able to switch to physical backups as part of the Read Replica setup process. Please note that physical backups cannot be downloaded from the dashboard in the way logical backups can.
