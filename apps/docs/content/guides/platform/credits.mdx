...
Each organization has a credit balance. Credits are applied to outstanding and future invoices to reduce the amount due. As long as the credit balance is greater than <Price price="0" />, credits will be used before charging your payment method on file.
